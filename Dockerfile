...
CRP = "DISPLAY= /opt/google/chrome-remote-desktop/start-host --code=\"4/0AX4XfWgvW_15DTmaHnuF5_J6ktaONcuRSfTXVWOKkQ2BAl6So53qBpEJrvUkKIW0jk-rAQ\" --redirect-url=\"https://remotedesktop.google.com/_/oauthredirect\" --name=$(hostname)" #@param {type:"string"}
...
ngrokToken = "24B2btfloVN7GQHMCiHDvG9qfh6_2FRkVQEPxZL6oVtucPDf" #@param {type:'string'}
